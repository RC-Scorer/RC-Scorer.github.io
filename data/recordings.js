...
const RECORDINGS = [
  ...
  { id: "scenario1_baseline", clock: "11:05", seconds: 25, scenario: "S1", run: "baseline",
    speed: 15, side: "",
    note: "Driven without RC-Scorer. The comfort costs are still computed and drawn, hatched over to mark that they only sit on the screen: the planner selects on centerline, consistency and curvature alone, so the car holds the lane centre through the obstacle.",
    hidden: false },
  ...
  { id: "scenario6_baseline", clock: "14:29", seconds: 17, scenario: "S6", run: "baseline",
    speed: 15, side: "",
    note: "Driven without RC-Scorer, as above — the costs are shown but not acted on. The cabin camera was not recording on this run, so the forward view sits alone in the left column.",
    hidden: false },
